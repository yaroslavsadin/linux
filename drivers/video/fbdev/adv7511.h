 ...
 * @ADV7511_INPUT_ID_24BIT_RGB444_YCbCr444:
 *	Input pixel format is 24-bit 444 RGB
 ...
 *	Selects the input format bit justifiction
 * ADV7511_INPUT_BIT_JUSTIFICATION_EVENLY:
 *	Input bits are evenly distributed
 * ADV7511_INPUT_BIT_JUSTIFICATION_RIGHT:
 *	Input bit signals have right justification
 * ADV7511_INPUT_BIT_JUSTIFICATION_LEFT:
 *	Input bit signals have left justification
 **/
enum adv7511_input_bit_justifiction {
 ...
 *	Selects the input format color depth
 * @ADV7511_INPUT_COLOR_DEPTH_8BIT:
 *	Input format color depth is 8 bits per channel
 * @ADV7511_INPUT_COLOR_DEPTH_10BIT:
 *	Input format color dpeth is 10 bits per channel
 * @ADV7511_INPUT_COLOR_DEPTH_12BIT:
 *	Input format color depth is 12 bits per channel
 **/
enum adv7511_input_color_depth {
 ...
 * mode. If the polarity is set to ADV7511_SYNC_POLARITY_PASSTHROUGH, the
 * ADV7511 will route the signal unchanged, this is useful if the upstream
 ...
 *	Selects the order in which timing adjustments are performed
 * @ADV7511_TIMING_GEN_SEQ_SYN_ADJ_FIRST:
 *	Sync adjustment first, then DE generation
 * @ADV7511_TIMING_GEN_SEQ_DE_GEN_FIRST:
 *	DE generation first, then sync adjustment
 *
