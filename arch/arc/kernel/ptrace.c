...
#else
static int arcv2_genregs_get(struct task_struct *target,
		       const struct user_regset *regset,
		       unsigned int pos, unsigned int count,
		       void *kbuf, void __user *ubuf)
{
...
static int arcv2_genregs_set(struct task_struct *target,
		       const struct user_regset *regset,
		       unsigned int pos, unsigned int count,
		       const void *kbuf, const void __user *ubuf)
{
...
#define REG_IGNORE_ONE(LOC)		\
	...
	REG_IN_ONE(scratch.status32, &ptregs->status32);
...
static const struct user_regset arc_regsets[] = {
	[REGSET_GENERAL] = {
	       ...
	       .set = genregs_set,
#else
	       .get = arcv2_genregs_get,
	       .set = arcv2_genregs_set,
#endif
	}
};
